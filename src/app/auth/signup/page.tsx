...
import { Eye, EyeOff, ArrowLeft, User, Mail, Lock, AlertCircle, Sparkles } from "lucide-react"
          ...
          >
            <Card className="bg-white/80 dark:bg-gray-800/90 backdrop-blur-sm shadow-2xl border border-white/20 dark:border-gray-700/50 transition-colors duration-300">
              <CardHeader className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300 mt-2 transition-colors duration-300">Create your account in seconds</p>
              </CardHeader>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="username" className="text-sm font-medium text-gray-700 dark:text-gray-300 transition-colors duration-300">
                      Username
                    </Label>
